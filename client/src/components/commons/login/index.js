...
const Login = ({ adm }) => {
  ...
  const submitHandler = (values) => {
    ...
    action.doLogin(values, dispatch, adm);
  };
  ...
  }, [sessionData, dispatch, history, authAlert.fire, authAlert.message, adm, redirectTo]);
      ...
      <div className="login-box" id="login" style={{ minHeight: 466 }}>
        <div className="card login-card">
          ...
          <div className="card-body">
            ...
            <p className="mb-1">
              <Link to={`/${!adm ? 'client' : 'admin'}/forgot`}>Forgot password?</Link>
            </p>
            {!adm ? (
              <>
                <p className="mb-0">
                  <Link to="/client/register" className="text-center">
                    Sign up
                  </Link>
                </p>
